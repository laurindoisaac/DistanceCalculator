// src/lib.rs
/*
 * Core library for DistanceCalculator
 */
...
#[derive(Debug)]
pub struct DistanceCalculatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DistanceCalculatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DistanceCalculator processing");
    
    let mut processor = DistanceCalculatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DistanceCalculatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DistanceCalculatorProcessor::new(false);
